...
will be treated as referenced types. Note that streams cannot be created using these referenced types.  In nested collections, there is a maximum depth limit of 32 placed on the entire JSON object.  
